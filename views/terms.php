...
<head>
    ...
    <title>Conditions d'Utilisation - FindIN</title>
...
<body>
    ...
    <div class="content">
        <section class="section">
            <h2>1. Objet</h2>
            <p>Les présentes conditions générales régissent l'utilisation de la plateforme FindIN, accessible à l'adresse findin.io, éditée par FindIN SAS.</p>
        </section>

        <section class="section">
            <h2>2. Accès au service</h2>
            <p>L'accès à FindIN nécessite la création d'un compte utilisateur. L'utilisateur s'engage à fournir des informations exactes et à maintenir la confidentialité de ses identifiants.</p>
        </section>
        ...
        <section class="section">
            ...
            <p>FindIN et tous ses composants (code, design, marques) sont protégés par le droit de la propriété intellectuelle. Toute reproduction non autorisée est interdite.</p>
        </section>

        <section class="section">
            <h2>5. Responsabilité</h2>
            <p>FindIN s'efforce d'assurer la disponibilité et la sécurité du service mais ne peut garantir une disponibilité de 100%. L'utilisateur reste responsable de l'utilisation qu'il fait de ses données.</p>
        </section>

        <section class="section">
            <h2>6. Résiliation</h2>
            <p>Chaque partie peut résilier le service à tout moment. L'utilisateur peut supprimer son compte depuis les paramètres. FindIN peut suspendre un compte en cas de violation des présentes conditions.</p>
        </section>
    ...
    <footer class="footer">
        <div class="footer-links"><a href="/about">À propos</a><a href="/contact">Contact</a><a href="/privacy">Confidentialité</a><a href="/cgu">CGU</a><a href="/mentions_legales">Mentions légales</a></div>
